// Seed with pre-generated fake embeddings for testing
// This allows testing without needing embedding API calls
const { MongoClient } = require("mongodb")
require("dotenv/config")

// Generate a random 768-dimension vector (same as text-embedding-004)
function generateFakeEmbedding(seed) {
  const embedding = []
  // Use a simple pseudo-random generator with seed for consistency
  let x = seed
  for (let i = 0; i < 768; i++) {
    x = (x * 9301 + 49297) % 233280
    embedding.push((x / 233280) * 2 - 1) // Value between -1 and 1
  }
...
const sampleFurniture = [
  {
    ...
    item_description: "A luxurious 3-seater leather sofa with soft cushions and sturdy wooden frame",
    brand: "ComfortLiving",
    ...
    user_reviews: [
      { review_date: "2024-01-15", rating: 5, comment: "Extremely comfortable and stylish!" },
      { review_date: "2024-02-20", rating: 4, comment: "Great quality, fast delivery" }
    ],
  ...
  },
  {
    ...
    item_description: "Solid oak wood dining table that seats 6 people comfortably",
    brand: "WoodCraft",
    manufacturer_address: {
    ...
    user_reviews: [
      { review_date: "2024-03-10", rating: 5, comment: "Beautiful craftsmanship!" },
  ...
  },
  {
    ...
    item_description: "Adjustable office chair with lumbar support and breathable mesh back",
    brand: "ErgoComfort",
    manufacturer_address: {
    ...
    user_reviews: [
      { review_date: "2024-05-12", rating: 4, comment: "Great for long work hours" },
      { review_date: "2024-06-18", rating: 5, comment: "My back pain is gone!" }
    ],
  ...
  },
  {
    ...
    item_description: "Modern platform bed with upholstered headboard and sturdy slats",
    brand: "DreamSleep",
    manufacturer_address: {
    ...
    user_reviews: [
      { review_date: "2024-07-22", rating: 5, comment: "Easy assembly and very sturdy" },
      { review_date: "2024-08-30", rating: 4, comment: "Looks exactly like the pictures" }
    ],
  ...
  },
  {
    ...
    item_description: "Adjustable standing desk that sits on top of existing desk",
    brand: "StandUp",
    manufacturer_address: {
    ...
    user_reviews: [
      { review_date: "2024-09-05", rating: 5, comment: "Perfect for working from home" },
      { review_date: "2024-10-11", rating: 4, comment: "Smooth height adjustment" }
    ],
  ...
  },
  {
    ...
    item_description: "5-tier metal and wood bookshelf with rustic industrial design",
    brand: "UrbanLoft",
    manufacturer_address: {
    ...
    user_reviews: [
      { review_date: "2024-11-01", rating: 5, comment: "Love the industrial look!" },
      { review_date: "2024-11-15", rating: 4, comment: "Very sturdy for the price" }
    ],
  ...
  },
  {
    ...
    item_description: "Tripod floor lamp with fabric shade and walnut wood legs",
    brand: "LightHouse",
    manufacturer_address: {
    ...
    user_reviews: [
      { review_date: "2024-12-01", rating: 5, comment: "Beautiful warm lighting" },
  ...
  },
  {
    ...
    item_description: "Tall storage cabinet with adjustable shelves and soft-close doors",
    brand: "HomeOrganize",
    manufacturer_address: {
    ...
    user_reviews: [
      { review_date: "2025-01-02", rating: 4, comment: "Great storage solution" },
  ...
  },
  {
    ...
    item_description: "Hand-woven 8x10 area rug with traditional Persian patterns",
    brand: "RugMaster",
    manufacturer_address: {
    ...
    user_reviews: [
      { review_date: "2025-01-01", rating: 5, comment: "Gorgeous colors and patterns" },
  ...
  },
  {
    ...
    user_reviews: [
      { review_date: "2025-01-03", rating: 5, comment: "Makes the room look bigger!" },
...
async function seedDatabase() {
  ...
  try {
    ...
    // Process items with fake embeddings
    console.log("\n📦 Inserting items with fake embeddings (for testing)...\n")
    
    const documents = sampleFurniture.map((item, index) => {
      const embeddingText = createEmbeddingText(item)
      // Generate deterministic fake embedding based on item index
      const embedding = generateFakeEmbedding(index * 12345 + 67890)
    ...
    console.log(`✅ Inserted ${documents.length} items`)
    ...
    try {
      ...
      console.log("⚠️  Note: Vector index creation requires Atlas M10+ cluster")
      console.log("   Error:", e.message)
    }

    console.log("\n" + "=".repeat(50))
    console.log("🎉 Database seeding completed!")
    console.log(`📊 Total items inserted: ${documents.length}`)
    console.log("=".repeat(50))
    console.log("\n⚠️  NOTE: Using FAKE embeddings for testing.")
    console.log("   Vector search will NOT work properly.")
    console.log("   But text-based search and basic queries will work.\n")
